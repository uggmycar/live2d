...
// 后端接口
live2d_settings['modelAPI']             = 'https://live2d.fghrsh.net/api/';   // 自建 API 修改这里//live2d.fghrsh.net/api/（这是作者的）//cdn.jsdelivr.net/gh/uggmycar/live2d_api@latest/(无用git大于50没用。。。)
